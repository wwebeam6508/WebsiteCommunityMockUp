...
import { ChatBubbleOvalLeftIcon, HandThumbUpIcon, ScaleIcon } from '@heroicons/react/16/solid';

interface LawPostProps {
...
const LawPost: React.FC<LawPostProps> = ({ posts, className }) => {
  // Implement the component logic here
  return (
    <div className={`border-t-2 border-gray-200 p-8 ${className}`}>
      <div className="mx-auto">
        <div className='flex'>
          <ScaleIcon className="h-8 w-8 mr-1" aria-hidden="true" />
