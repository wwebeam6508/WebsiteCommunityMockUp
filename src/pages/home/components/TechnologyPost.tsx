...
import { ChatBubbleOvalLeftIcon, HandThumbUpIcon, WrenchIcon } from '@heroicons/react/16/solid';
...
const TechnologyPost: React.FC<TechnologyPostProps> = ({ posts, className }) => {
  // Implement the component logic here
  return (
    <div className={`border-t-2 border-gray-200 p-8 ${className}`}>
      <div className="mx-auto">
        <div className='flex'>
          <WrenchIcon className="h-8 w-8 mr-1" aria-hidden="true" />
